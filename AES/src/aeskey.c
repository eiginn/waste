...
/*
 * This file generated extend key for 192 & 256 which cann't be generated 
 * by hardware
*/
...
aes_rval c5p_encrypt_key(const void *in_key, int key_len, aes_encrypt_ctx cx[1])
{
	return aes_encrypt_key(in_key, key_len, cx);
}
...
aes_rval c5p_decrypt_key128(const void *in_key, aes_decrypt_ctx cx[1])
{   
	aes_32t    ss[5];
...
aes_rval c5p_decrypt_key192(const void *in_key, aes_decrypt_ctx cx[1])
{   
	aes_32t    ss[7];
...
aes_rval c5p_decrypt_key256(const void *in_key, aes_decrypt_ctx cx[1])
{   
	aes_32t    ss[8];
...
aes_rval c5p_decrypt_key(const void *in_key, int key_len, aes_decrypt_ctx cx[1])
{
    switch(key_len)
    {
#ifdef AES_ERR_CHK
    case 16: case 128: return c5p_decrypt_key128(in_key, cx);
    case 24: case 192: return c5p_decrypt_key192(in_key, cx);
    case 32: case 256: return c5p_decrypt_key256(in_key, cx);
    default: return aes_error;
#else
    case 16: case 128: c5p_decrypt_key128(in_key, cx); return;
    case 24: case 192: c5p_decrypt_key192(in_key, cx); return;
    case 32: case 256: c5p_decrypt_key256(in_key, cx); return;
#endif
    }
}
